...
class Commentaire
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Helios\BlogBundle\Entity\Notification", inversedBy="commentaires")
     * @ORM\JoinColumn(nullable=false)
     */
     ...
     * @return Commentaire
     */
    public function setNotification(\Helios\BlogBundle\Entity\Notification $notification)
    {
